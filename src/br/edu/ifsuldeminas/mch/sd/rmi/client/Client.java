...
public class Client {
	public static void main(String[] args) {
		try {
			...
			System.out.println("Raiz: " + calc.raiz(8.0, 3.0));
			System.out.println("Potencia: " + calc.pot(7.0, 7.0));
			System.out.println("Porcentagem: " + calc.por(10.0, 600.0));
			System.out.println("Modulo: " + calc.mod(25.0,3.0));
			System.out.println("Fatorial: " + calc.fat(7.0));
			System.out.println("Converção decimal: " + calc.dec(7));
			System.out.println("Converção hexadecimal: " + calc.hex(7));
